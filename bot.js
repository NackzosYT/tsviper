...
ViperBot
		...
		=-=-=-=-=-= 🌍اوامر نادرة🌍 =-=-=-=-=-=
#log مضاد جحفلة (تهكير) : فقط اعطي البوت رتبه عاليه لازم روم
#log : اعمل روم باسم لروئيه اي امر يصير في السيرفر
&autorole set [name] : لاعطاء رتبه تلقائية عند دخول العضو
&autorole toggle : لتشغيل او اطفاء الرتبه التلقائية
قريبا اوامر الترحيب بالصوره والكتابه
		=-=-=-=-=-= 🌍اوامر الادارة🌍 =-=-=-=-=-=
...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/oauth2/authorize?client_id=534113512025358347&permissions=8&scope=bot')
  .setDescription(`**
...
client.channels.get("534113512025358347").sendEmbed(embed)
});
...
client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/35fndKW**")
